  ...
  return (
    <div className="col-11 mx-auto">
          ...
          <div
            ...
            <div className="accordion-body">
              <li className="accordion-list-item">
                DAAD scholarships are open to students seeking a degree in
                engineering or science who want to complete their three-month
                internship program at a public German institution. Undergraduate
                students who are chosen will get 861 EUR per month to cover
                living expenses, as well as 1,050 EUR in travel aid and payments
          ...
          <div
            ...
            <div className="accordion-body">
              <div className="accordion-list-item">
                ...
                <li>
                  Contribute to travel, German student visa and a living
                  allowance
                </li>
                <li>
                  Can be applied directly to the institution running their
                  chosen program
                </li>
              </div>
            </div>
          ...
          <div
            ...
            <div className="accordion-body">
              <div className="accordion-list-item">
                <li>
                  {" "}
                  Possess a bachelor's degree (first degree), be in his final
                  year of undergraduate study, or have already graduated before
                  the start of the master's program in Germany.
                </li>
                <li>He must have scored 70% or more in Batchelor's.</li>
                <li>
                  He may also apply If he can prove that he has the learning
                  capacity of a bachelor.
                </li>
              </div>
            </div>
          </div>
      ...
      <div
        ...
        <span className="scholarshipTitleBox" style={{ fontSize: "1.5rem" }}>
          Verify the Documents and Apply for Scholarship
        </span>
      </div>
      <div style={{ textAlign: "left" }}>
        <div className="py-3 d-flex" style={{ alignItems: "center" }}>
          <div className="" style={{ fontWeight: "650", fontSize: "1.5rem" }}>
            {" "}
            Verify Graduation Percentage:
          </div>
          ...
          />
          <div className="d-flex py-2" style={{ fontWeight: "600" }}></div>
        </div>
      </div>
    </div>
  );
